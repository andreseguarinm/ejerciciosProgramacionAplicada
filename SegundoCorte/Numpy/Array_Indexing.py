...
print(arr1[0]) #Se busca el primer elemento de la matriz
print(arr1[1}) #Se busca el segundo elemento de la matriz
...
print('Segundo elemento de la primera fila : ', arr2[0, 1]) #Corresponde al segundo valor de la primera fila, que en este caso es "2".
print('Quinto elemento de la segunda fila: ', arr2[1, 4])
...
print(arr3[0, 1, 2]) #En este caso, imprimirá el número 6
...
print('Último elemento de la segunda dimensión: ', arr4[1, -1])
