...
arr7 = np.array([1, 2, 3, 4], ndmin=5) #Se le asigna 5 dimensiones a la matriz con este arreglo de números
print(arr7)
print('Número de Dimensiones :', arr7.ndim) #Aparecerá que son 5
